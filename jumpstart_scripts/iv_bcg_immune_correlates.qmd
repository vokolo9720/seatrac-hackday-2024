...
Try sorting diffs_tbl to find parameters that differ between teh protected and non protected groups.

You may wish to :

* `filter(tp = 0)` to filter to the pre-BCG timepoint
...
function we used above to examine values of an immune variable logitudinally.
